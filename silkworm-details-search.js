...
["stanza1.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\r\nPREFIX sio: <http://semanticscience.org/resource/>\r\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\r\nPREFIX so: <http://purl.obolibrary.org/obo/so#>\r\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\r\nPREFIX faldo: <http://biohackathon.org/resource/faldo#>\r\nPREFIX dcterms: <http://purl.org/dc/terms/>\r\nPREFIX insdc: <http://ddbj.nig.ac.jp/ontologies/nucleotide/>\r\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\r\nPREFIX org: <http://www.w3.org/ns/org#>\r\nPREFIX bibo: <http://purl.org/ontology/bibo/>\r\nPREFIX obo: <http://purl.obolibrary.org/obo/>\r\n\r\n\r\nSELECT distinct\r\n	\""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":16,"column":2},"end":{"line":16,"column":8}}}) : helper))) != null ? stack1 : "")
    + "\" as ?id\r\n	?strain\r\n	?taxonomy_id\r\n	?description\r\n	(group_concat(distinct ?origin;separator = \", \") AS ?origin)\r\n	(group_concat(distinct ?rrc;separator = \"\\n\") AS ?rrc)\r\n	?homepage\r\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\r\nWHERE {\r\n	?Resource a brso:BiologicalResource ;\r\n		dcterms:identifier \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":26,"column":22},"end":{"line":26,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\" ;\r\n		rdfs:label ?strain ;\r\n		brso:organism _:b_organism ;\r\n		dcterms:description ?description ;\r\n		foaf:homepage ?homepage .\r\n	filter(LANG(?description) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":31,"column":30},"end":{"line":31,"column":42}}}) : helper))) != null ? stack1 : "")
...
["stanza2.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
["stanza3.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\r\nPREFIX sio: <http://semanticscience.org/resource/>\r\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\r\nPREFIX so: <http://purl.obolibrary.org/obo/so#>\r\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\r\nPREFIX faldo: <http://biohackathon.org/resource/faldo#>\r\nPREFIX dcterms: <http://purl.org/dc/terms/>\r\nPREFIX insdc: <http://ddbj.nig.ac.jp/ontologies/nucleotide/>\r\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\r\nPREFIX org: <http://www.w3.org/ns/org#>\r\nPREFIX bibo: <http://purl.org/ontology/bibo/>\r\nPREFIX obo: <http://purl.obolibrary.org/obo/>\r\nPREFIX prism: <http://prismstandard.org/namespaces/basic/2.0/>\r\n\r\n\r\nSELECT distinct\r\n	?gene_id\r\n	?gene_name\r\n	(group_concat(distinct ?gene_synonym;separator = \", \") AS ?gene_synonym)\r\n	?gene_url\r\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\r\nWHERE {\r\n	?Resource a brso:BiologicalResource ;\r\n		dcterms:identifier \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":24,"column":22},"end":{"line":24,"column":28}}}) : helper))) != null ? stack1 : "")
    + "\" ;\r\n		brso:genomic_feature _:b_genomic_feature .\r\n\r\n	_:b_genomic_feature a brso:GenomicFeature ;\r\n		brso:has_genomic_segment _:b_genomic_segment .\r\n	\r\n	_:b_genomic_segment a brso:GenomicSegment ;\r\n		dcterms:identifier ?gene_id ;\r\n		skos:altLabel ?gene_synonym ;\r\n		rdfs:seeAlso ?gene_url .\r\n		\r\n	OPTIONAL{\r\n		_:b_genomic_segment rdfs:label ?gene_name.\r\n	}\r\n}\r\n\r\n";
},"useData":true}],
["stanza3.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\r\nPREFIX sio: <http://semanticscience.org/resource/>\r\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\r\nPREFIX so: <http://purl.obolibrary.org/obo/so#>\r\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\r\nPREFIX faldo: <http://biohackathon.org/resource/faldo#>\r\nPREFIX dcterms: <http://purl.org/dc/terms/>\r\nPREFIX insdc: <http://ddbj.nig.ac.jp/ontologies/nucleotide/>\r\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\r\nPREFIX org: <http://www.w3.org/ns/org#>\r\nPREFIX bibo: <http://purl.org/ontology/bibo/>\r\nPREFIX obo: <http://purl.obolibrary.org/obo/>\r\n\r\n\r\nSELECT distinct\r\n	?name\r\n	?resource_state\r\n	(group_concat(distinct ?image;separator = \"\\n\") AS ?image)\r\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\r\nWHERE {\r\n	?Resource a brso:BiologicalResourceEgg ;\r\n		dcterms:identifier \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : container.hooks.helperMissing),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : (container.nullContext || {}),{"name":"id","hash":{},"data":data,"loc":{"start":{"line":22,"column":22},"end":{"line":22,"column":28}}}) : helper))) != null ? stack1 : "")
...
["stanza4.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : (container.nullContext || {}), alias2=container.hooks.helperMissing, alias3="function", lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
  ...
  return "PREFIX brso: <http://purl.jp/bio/10/brso/>\r\nPREFIX sio: <http://semanticscience.org/resource/>\r\nPREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>\r\nPREFIX so: <http://purl.obolibrary.org/obo/so#>\r\nPREFIX skos: <http://www.w3.org/2004/02/skos/core#>\r\nPREFIX faldo: <http://biohackathon.org/resource/faldo#>\r\nPREFIX dcterms: <http://purl.org/dc/terms/>\r\nPREFIX insdc: <http://ddbj.nig.ac.jp/ontologies/nucleotide/>\r\nPREFIX foaf: <http://xmlns.com/foaf/0.1/>\r\nPREFIX org: <http://www.w3.org/ns/org#>\r\nPREFIX bibo: <http://purl.org/ontology/bibo/>\r\nPREFIX obo: <http://purl.obolibrary.org/obo/>\r\nPREFIX prism: <http://prismstandard.org/namespaces/basic/2.0/>\r\n\r\n\r\nSELECT distinct\r\n	?phenotype_label\r\n	(group_concat(distinct ?bmpo;separator = \"\\n\") AS ?bmpo)\r\n	(group_concat(distinct ?dpo;separator = \"\\n\") AS ?dpo)\r\n	?phenotype_description\r\nFROM <http://iruddat2.nig.ac.jp:8120/silkworm>\r\nWHERE {\r\n	{\r\n		?Resource a brso:BiologicalResource ;\r\n			dcterms:identifier \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":25,"column":23},"end":{"line":25,"column":29}}}) : helper))) != null ? stack1 : "")
    + "\" ;\r\n			sio:SIO_001279 _:b_phenotype .\r\n\r\n		_:b_phenotype a sio:SIO_010056 ;\r\n			rdfs:label ?phenotype_label .\r\n		filter(LANG(?phenotype_label) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":30,"column":35},"end":{"line":30,"column":47}}}) : helper))) != null ? stack1 : "")
    + "')\r\n			\r\n		OPTIONAL{\r\n			_:b_phenotype sio:SIO_000255 ?bmpo.\r\n		}\r\n		OPTIONAL{\r\n			_:b_phenotype rdfs:seeAlso ?dpo.\r\n		}\r\n		OPTIONAL{\r\n			_:b_phenotype dcterms:description ?phenotype_description.\r\n			filter(LANG(?phenotype_description) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":40,"column":42},"end":{"line":40,"column":54}}}) : helper))) != null ? stack1 : "")
    + "')\r\n		}\r\n	}\r\n	UNION\r\n	{\r\n		?Resource a brso:BiologicalResource ;\r\n			dcterms:identifier \""
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"id") || (depth0 != null ? lookupProperty(depth0,"id") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data,"loc":{"start":{"line":46,"column":23},"end":{"line":46,"column":29}}}) : helper))) != null ? stack1 : "")
    + "\" ;\r\n			sio:SIO_001279 _:b_phenotype .\r\n\r\n		_:b_phenotype a sio:SIO_010056 ;\r\n			rdfs:label ?phenotype_label . \r\n		filter(LANG(?phenotype_label) = '')\r\n			\r\n		OPTIONAL{\r\n			_:b_phenotype sio:SIO_000255 ?bmpo.\r\n		}\r\n		OPTIONAL{\r\n			_:b_phenotype rdfs:seeAlso ?dpo.\r\n		}\r\n		OPTIONAL{\r\n			_:b_phenotype dcterms:description ?phenotype_description.\r\n			filter(LANG(?phenotype_description) = '"
    + ((stack1 = ((helper = (helper = lookupProperty(helpers,"language") || (depth0 != null ? lookupProperty(depth0,"language") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"language","hash":{},"data":data,"loc":{"start":{"line":61,"column":42},"end":{"line":61,"column":54}}}) : helper))) != null ? stack1 : "")
    + "')\r\n		}\r\n	}\r\n}\r\n\r\n";
},"useData":true}],
["stanza4.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
["stanza5.rq", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
["stanza5.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
...
["stanza6.rq.hbs", {"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, lookupProperty = container.lookupProperty || function(parent, propertyName) {
        if (Object.prototype.hasOwnProperty.call(parent, propertyName)) {
          return parent[propertyName];
        }
